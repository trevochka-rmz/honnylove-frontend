...
import { getProductById, getProducts } from '@/api/productApi'; // Импорт API
...
import { Label } from '@/components/ui/label'; // Если нет, добавьте import из ui/label
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                // Загружаем related: фильтр по category, limit 4
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 container mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                    ...
                    {/* Info */}
                    <div>
                        <p className="text-sm text-primary font-roboto mb-2">
                            {product.brand}
                        </p>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="w-12 text-center font-roboto font-medium">
                                    {quantity}
                                </span>
                                <Button
                                    variant="outline"
                ...
                <Tabs defaultValue="description" className="mb-12">
                    ...
                    <TabsContent value="description" className="mt-6">
                        <div className="prose max-w-none">
                            ...
                            {product.usage && (
                                <div className="mt-4">
                                    <h3 className="font-roboto font-semibold mb-2">
                                        Способ применения:
                                    </h3>
                                    <p className="font-roboto text-foreground/80">
                                        {product.usage}
                    ...
                    <TabsContent value="ingredients" className="mt-6">
                        <p className="font-roboto text-foreground/80">
                            {product.ingredients ||
                                'Информация о составе временно недоступна.'}
                        </p>
                    </TabsContent>

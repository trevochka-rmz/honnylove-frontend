        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card border border-border rounded-2xl p-6 md:p-8 prose prose-sm md:prose max-w-none">
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              Индивидуальному предпринимателю Мичкаевой Наталье Валерьевне 
              (ОГРНИП: 316370200080947, ИНН: 370380659086) (далее – Оператор) на обработку 
            ...
            <div className="mt-8 pt-6 border-t border-border">
              ...
              <div className="text-muted-foreground space-y-2">
                <p>ИП Мичкаева Наталья Валерьевна</p>
                <p>ОГРНИП: 316370200080947</p>
                <p>ИНН: 370380659086</p>

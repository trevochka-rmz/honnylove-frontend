...
const Brands = () => {
    const [brandsWithCounts, setBrandsWithCounts] = useState<Brand[]>([]);
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                        Мы тщательно отбираем лучшие бренды со всего мира, чтобы
                        предложить вам только качественную косметику и товары
                        для дома
                    </p>
                </div>
                {/* Brands Grid */}
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center">
                            ...
                            <p className="text-muted-foreground text-sm">
                                Мы работаем только с официальными
                                дистрибьюторами
                            </p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-muted-foreground text-sm">
                                Большинство брендов придерживаются принципов
